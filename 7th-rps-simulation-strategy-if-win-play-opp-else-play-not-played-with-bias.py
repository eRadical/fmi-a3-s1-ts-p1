...
choices_player1 = [CHOICE_ROCK, CHOICE_SCISSORS, CHOICE_PAPER]
choices_player2 = [CHOICE_ROCK, CHOICE_SCISSORS, CHOICE_SCISSORS, CHOICE_PAPER, CHOICE_PAPER, CHOICE_PAPER, CHOICE_PAPER]
...
while iteration_start < rock_paper_scissors.iterations:
    ...
    if iteration_start == 0:
        ...
        if winner == 1:
            ...
            to_be_removed = [p1, p2]
            not_played_last_round = [item for item in choices_player1 if item not in to_be_removed]
            p1 = rock_paper_scissors.random_extract_from_choices(not_played_last_round)
